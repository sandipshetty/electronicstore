		...
		<div class="col-md-10">
					...
					<div id="carousel-example-generic" class="carousel slide"
						...
						<div class="carousel-inner">
							<div class="item active">
								<img class="slide-image" src="${images}/bg1.jpg"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="${images}/bg2.jpg"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="${images}/bg3.jpg"
									alt="">
							</div>
						</div>
			...
			<div class="row">
				...
				<div class="col-sm-4 col-lg-4 col-md-4">
					<div class="thumbnail">
						<img src="http://placehold.it/320x150" alt="" height="42"
							width="42">
						<div class="caption">
