...
public class Product {
	...
	public Product(int productId, String productName, int categoryId, int userId, int price, int quantity,
	...
	public String toString() {
		return "Product [productId=" + productId + ", productName=" + productName + ", categoryId=" + categoryId
				+ ", userId=" + userId + ", price=" + price + ", quantity=" + quantity + ", description=" + description
